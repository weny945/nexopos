...
const nsAlipayTestConnection        =   defineAsyncComponent( () => import( './components/ns-alipay-test-connection.vue' ) );
const nsWeChatTestConnection        =   defineAsyncComponent( () => import( './components/ns-wechat-test-connection.vue' ) );
...
const allComponents    =   Object.assign({
    ...
    nsAlipayTestConnection,
    nsWeChatTestConnection,
    ...baseComponents
}, nsExtraComponents );
