                ...
                nsHttpClient.get( url )
                    .subscribe({
                        next: result => {
                            ...
                            product.quantity                =   1; // Default quantity for barcode scanning

                            /**
                             * OPTIMIZATION: Pass the full product data to avoid extra API calls
                             * This allows ProductUnitPromise to check if there's only one unit
                             * and skip the popup entirely
                             */
                            product.$original                =   () => result.product;
