    ...
    <div class="h-full w-full py-2">
        <div class="px-2 pb-2" v-if="order">
            <div class="grid grid-cols-2 gap-2">
                ...
                <div class="col-span-2 h-16 flex justify-between items-center elevation-surface border text-xl md:text-3xl p-2 bg-green-50">
        ...
        <div class="px-2 pb-2">
            <div class="flex flex-col gap-2">
                ...
                <div class="elevation-surface border p-4">
                    <label class="block text-sm font-medium mb-2">{{ __( 'Scan or enter WeChat payment code' ) }}</label>
                    <div class="flex gap-2">
                        ...
                        <button
                            v-if="hasCamera"
                            @click="toggleScanner"
                            class="h-12 px-4 bg-success text-white"
                            :disabled="processing"
                        >
