...
class FormInput
{
    ...
    /**
     * Creates a masked text input field for sensitive data (API keys, passwords, etc.)
     * Shows masked value by default with toggle to reveal.
     *
     * @param  string        $label       The label for the input field.
     * @param  string        $name        The name attribute for the input field.
     * @param  string        $value       The default value of the input field.
     ...
     * @param  bool          $disabled    Whether the input field is disabled.
     * @param  callable|null $show        A callable that determines whether the input field should be displayed.
     * @return array         An associative array representing the masked text field configuration.
     */
    public static function maskedText( $label, $name, $value = '', $validation = '', $description = '', $disabled = false, $show = null )
    {
        return self::text(
            label: $label,
            name: $name,
    ...
    /**
     * Creates a masked textarea field for sensitive data (private keys, certificates, etc.)
     * Shows masked value by default with toggle to reveal.
     *
     * @param  string        $label       The label for the textarea field.
     * @param  string        $name        The name attribute for the textarea field.
     ...
     * @param  bool          $disabled    Whether the textarea field is disabled.
     * @param  callable|null $show        A callable that determines whether the textarea field should be displayed.
     * @return array         An associative array representing the masked textarea field configuration.
     */
    public static function maskedTextarea( $label, $name, $value = '', $validation = '', $description = '', $disabled = false, $show = null )
    {
        return self::text(
            label: $label,
            name: $name,
