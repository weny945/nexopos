    ...
    SettingForm::tab(
        ...
        fields: SettingForm::fields(
            ...
            FormInput::select(
                ...
                description: __( 'Select the default order type for POS. This will be automatically selected when creating a new order.' ),
                name: 'ns_orders_default_type',
                value: ns()->option->get( 'ns_orders_default_type', 'takeaway' ),
