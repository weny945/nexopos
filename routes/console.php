...
/**
 * Compute category product counts daily.
 * This will recursively update the total_items field for all categories.
 */
Schedule::command( 'categories:compute' )->dailyAt( '02:00' );
