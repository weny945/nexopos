...
Route::post( 'products/unit-quantities/{unitQuantity}/convert-to-linked', [ ProductsController::class, 'convertToLinkedProduct' ] )->middleware( NsRestrictMiddleware::arguments( 'nexopos.convert.products-units' ) );
